...
const themes = {
  adjectives: () => import("./words/adjectives-20.js"),
  ...
  animals: () => import("./words/animals-20.js"),
  ...
  cities: () => import("./words/cities-20.js"),
  ...
  clothing: () => import("./words/clothing-20.js"),
  ...
  colors: () => import("./words/colors-20.js"),
  ...
  countries: () => import("./words/countries-20.js"),
  ...
  elements: () => import("./words/elements-20.js"),
  ...
  emotions: () => import("./words/emotions-20.js"),
  ...
  nature: () => import("./words/nature-20.js"),
  ...
  snacks: () => import("./words/snacks-20.js"),
...
async function main(): Promise<void> {
  ...
  try {
    ...
    const result = codename(inputNumber);
    console.log(result);
  } catch (error) {
    console.error(
